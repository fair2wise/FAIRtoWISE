"""
Base PublicationAnalysis Module
------------------------------
Base class for publication analysis that can be extended by specific LLM provider implementations.
"""
...
class BasePublicationAnalysis(ABC):
    """Base class for publication analysis that handles common functionality."""
    ...
    def call_llm(self, prompt: str) -> Any:
        """Call the LLM with a prompt. Must be implemented by subclasses."""
        pass
